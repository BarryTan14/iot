"""
Django settings for evicted project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-9b3)cssw-ak77ni30e*&1wr$ipum@39lr4&efx%op#4j6q2%si")
...
# Option 1: DATABASE_URL (from Supabase dashboard → Settings → Database → Connection string)
# Option 2: Individual SUPABASE_* env vars
...
if _db_url and (_db_url.startswith("postgres://") or _db_url.startswith("postgresql://")):
    ...
    DATABASES = {
        "default": {
            ...
            "OPTIONS": {"sslmode": "require"} if os.environ.get("SUPABASE_SSL") else {},
        }
    }
else:
    DATABASES = {
...
# MQTT broker: Evicted publishes events to this topic; a subscriber consumes and handles them (e.g. SMS, integrations).
...
MQTT_TOPIC_FORM = os.environ.get("MQTT_TOPIC_FORM", "evicted/form")  # topic name; subscriber does whatever they need with messages
